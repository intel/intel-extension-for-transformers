...
public:
  ...
  explicit layernormalized_spmm_k_t(const std::shared_ptr<const kd_t> &kd)
      : kernel_t(kd) {
    kernels_.resize(2);
  }
  ...
  layernormalized_spmm_k_t &
  operator=(layernormalized_spmm_k_t &&other) = delete;
  // Delete copy constructor and copy operator
  layernormalized_spmm_k_t(const layernormalized_spmm_k_t &other) = delete;
  layernormalized_spmm_k_t &
  operator=(const layernormalized_spmm_k_t &other) = delete;
