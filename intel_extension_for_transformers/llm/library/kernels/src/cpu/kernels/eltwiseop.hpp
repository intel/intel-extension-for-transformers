...
public:
  ...
  explicit eltwiseop_k_t(const std::shared_ptr<const kd_t> &kd)
      : kernel_t(kd) {}
...
private:
  bool eltwiseop_kernel_create(jit_eltwiseop_t **ker_pp,
                               const ssd::eltwiseop_param_t &param);
