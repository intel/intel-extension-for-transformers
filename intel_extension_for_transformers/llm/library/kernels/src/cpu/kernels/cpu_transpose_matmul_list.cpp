...
static const std::map<map_key_t, std::vector<impl_list_item_t>> impl_list_map =
    {
        {{kernel_prop::forward_inference, data_type::fp32, data_type::fp32,
          data_type::fp32},
         {CPU_INSTANCE(matmul_avx512f_p2031_p2013_k_t),
          CPU_INSTANCE(matmul_ref_k_t), NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::bf16, data_type::bf16,
          data_type::bf16},
         {CPU_INSTANCE(matmul_avx512f_8bit_k_t), CPU_INSTANCE(matmul_ref_k_t),
          NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::bf16, data_type::s8,
          data_type::bf16},
         {CPU_INSTANCE(matmul_avx512f_8bit_k_t), CPU_INSTANCE(matmul_ref_k_t),
          NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::bf16, data_type::f8_e4m3,
          data_type::bf16},
         {CPU_INSTANCE(matmul_avx512f_8bit_k_t), CPU_INSTANCE(matmul_ref_k_t),
          NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::bf16, data_type::f8_e5m2,
          data_type::bf16},
         {CPU_INSTANCE(matmul_avx512f_8bit_k_t), CPU_INSTANCE(matmul_ref_k_t),
          NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::u8, data_type::s8,
          data_type::u8},
         {CPU_INSTANCE(matmul_vnni_noperm_p2031_p1302_k_t),
          CPU_INSTANCE(matmul_ref_k_t), NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::s8, data_type::s8,
          data_type::fp32},
         {CPU_INSTANCE(matmul_vnni_p2031_p2013_k_t),
          CPU_INSTANCE(matmul_ref_k_t), NULL_INSTANCE()}},
        {{kernel_prop::forward_inference, data_type::s8, data_type::s8,
          data_type::u8},
         {CPU_INSTANCE(matmul_vnni_p2031_p2013_k_t),
...
get_transpose_matmul_impl_list(const operator_desc &op_desc) {
  ...
  return (impl_list_it != impl_list_map.end()) ? &(impl_list_it->second)
