...
public:
  ...
  DECLARE_COMMON_PD_T(matmul_avx512f_p2031_p2013_k_t,
                      matmul_avx512f_p2031_p2013_kd_t);
...
public:
  ...
  explicit matmul_avx512f_p2031_p2013_k_t(
      const std::shared_ptr<const kd_t> &kd);
  virtual ~matmul_avx512f_p2031_p2013_k_t() { safe_delete(jit_ker_); }

  // Delete move constructor and move operator
  matmul_avx512f_p2031_p2013_k_t(matmul_avx512f_p2031_p2013_k_t &&other) =
      delete;
  matmul_avx512f_p2031_p2013_k_t &
  operator=(matmul_avx512f_p2031_p2013_k_t &&other) = delete;
  // Delete copy constructor and copy operator
  matmul_avx512f_p2031_p2013_k_t(const matmul_avx512f_p2031_p2013_k_t &other) =
      delete;
  matmul_avx512f_p2031_p2013_k_t &
  operator=(const matmul_avx512f_p2031_p2013_k_t &other) = delete;
...
private:
  bool matmul_kernel_create(jit_matmul_avx512f_p2031_p2013_t **ker_pp,
