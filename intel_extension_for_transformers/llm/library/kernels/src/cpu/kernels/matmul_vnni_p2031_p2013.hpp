...
public:
  ...
  DECLARE_COMMON_PD_T(matmul_vnni_p2031_p2013_k_t,
                      matmul_vnni_p2031_p2013_kd_t);
...
public:
  ...
  matmul_vnni_p2031_p2013_k_t &
  operator=(matmul_vnni_p2031_p2013_k_t &&other) = delete;
  // Delete copy constructor and copy operator
  matmul_vnni_p2031_p2013_k_t(const matmul_vnni_p2031_p2013_k_t &other) =
      delete;
  matmul_vnni_p2031_p2013_k_t &
  operator=(const matmul_vnni_p2031_p2013_k_t &other) = delete;
  ...
  template <typename dt_dst>
  bool thread_exec(const std::vector<const void *> &rt_data, const dim_t ibs0,
