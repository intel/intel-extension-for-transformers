...
void jit_seq_cpy_2x8x8::generate() {
  ...
  je(l_n_loop_end, T_NEAR);
  {
    ...
    vmovdqa32(zword[reg_dst + reg_ld_dst],
  ...
  je(l_ntail_end, T_NEAR);
  {
    ...
    if (val_offset)
      vmovdqa32(vreg_val_offset | reg_k_tail | T_z, vreg_val_offset);

    vmovdqu8(Xbyak::Xmm(v_res0.getIdx()) | reg_k_tail | T_z, ptr[reg_src]);
    vmovdqu8(Xbyak::Xmm(vreg_t2.getIdx()) | reg_k_tail | T_z,
             ptr[reg_src + reg_ld_src]);
    vshuff32x4(Xbyak::Ymm(v_res0.getIdx()), Xbyak::Ymm(v_res0.getIdx()),
               Xbyak::Ymm(vreg_t2.getIdx()), 0b00);
    vmovdqu8(Xbyak::Xmm(vreg_t1.getIdx()) | reg_k_tail | T_z,
             ptr[reg_src + reg_ld_src * 2]);
    vmovdqu8(Xbyak::Xmm(vreg_t2.getIdx()) | reg_k_tail | T_z,
             ptr[reg_src + reg_3ld_src]);
    ...
    vmovdqu8(Xbyak::Xmm(vreg_t2.getIdx()) | reg_k_tail | T_z,
             ptr[reg_tmp + reg_ld_src * 1]);
    vshuff32x4(Xbyak::Ymm(v_res1.getIdx()), Xbyak::Ymm(v_res1.getIdx()),
               Xbyak::Ymm(vreg_t2.getIdx()), 0b00);
    vmovdqu8(Xbyak::Xmm(vreg_t1.getIdx()) | reg_k_tail | T_z,
             ptr[reg_tmp + reg_ld_src * 2]);
    vmovdqu8(Xbyak::Xmm(vreg_t2.getIdx()) | reg_k_tail | T_z,
             ptr[reg_tmp + reg_3ld_src]);
    vshuff32x4(Xbyak::Ymm(vreg_t1.getIdx()), Xbyak::Ymm(vreg_t1.getIdx()),
               Xbyak::Ymm(vreg_t2.getIdx()), 0b00);
