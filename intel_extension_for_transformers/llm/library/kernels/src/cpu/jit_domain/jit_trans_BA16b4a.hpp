...
/**
 * @brief jit_trans_BA16b4a transpose a matrix of bytes of size mxn (ab) to
 * (n/16)x(m/4)x16x4 (BA16b4a). Paddings are set to zero.
 */
...
private:
  ...
  void transpose_4x64(regs_pool *const rp, const Xbyak::Reg64 &src,
                      const Xbyak::Reg64 &dst, const Xbyak::Reg64 &ld_dst,
