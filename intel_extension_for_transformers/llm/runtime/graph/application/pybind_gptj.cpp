...
char* eval_gptj_char(void* ctx, const char* prom, int n_predict, int top_k, float top_p, float temp, int n_batch, int min_new_tokens = 0, float length_penalty = 1.0f) {
  model_context* lctx = (model_context*)ctx;
  int n_past = 0;
