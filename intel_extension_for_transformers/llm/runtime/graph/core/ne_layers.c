...
NE_API struct ne_tensor * ne_conv_1d(
...
struct ne_tensor * ne_conv_1d_ph(
        struct ne_context * ctx,
        struct ne_tensor  * a,
        struct ne_tensor  * b,
        int                 s,
...
static void ne_compute_forward_conv_1d_s1_ph_f16_f32(
    ...
    for (int i1 = ir0; i1 < ir1; i1++) {
        ...
        for (int64_t i0 = 0; i0 < ne10; ++i0) {
            ...
            for (int k = -nh; k <= nh; k++) {
                float v = 0.0f;
                ne_vec_dot_f16(ew0, &v,
                        (ne_fp16_t *) params->wdata +   i1*ew0*ne00 +      (nh + k)*ew0,
...
static void ne_compute_forward_conv_1d_s1_ph_f32(
        const struct ne_compute_params * params,
        const struct ne_tensor * src0,
        const struct ne_tensor * src1,
              struct ne_tensor * dst) {
...
static void ne_compute_forward_conv_1d_s1_ph(
        const struct ne_compute_params * params,
        const struct ne_tensor * src0,
        const struct ne_tensor * src1,
              struct ne_tensor * dst) {
...
static void ne_compute_forward_conv_1d_s2_ph_f16_f32(
        const struct ne_compute_params * params,
        const struct ne_tensor * src0,
        const struct ne_tensor * src1,
              struct ne_tensor * dst) {
...
static void ne_compute_forward_conv_1d_s2_ph_f32(
        const struct ne_compute_params * params,
        const struct ne_tensor * src0,
        const struct ne_tensor * src1,
              struct ne_tensor * dst) {
...
static void ne_compute_forward_conv_1d_s2_ph(
        const struct ne_compute_params * params,
        const struct ne_tensor * src0,
        const struct ne_tensor * src1,
              struct ne_tensor * dst) {
...
static void ne_compute_forward_conv_1d(
        const struct ne_compute_params * params,
        const struct ne_tensor * src0,
        const struct ne_tensor * src1,
              struct ne_tensor * dst) {
