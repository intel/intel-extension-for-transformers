...
void JblasGemmCompF32(float* activation, jblas::storage::gemm::IWeightBase* w1ptr,
  ...
  if (seq <= 32) {
    ...
    typename Launcher_silu::Param args1{gp1, {activation, fin, &reduceA1}, {w1ptr_}, blkargs1, {tmp1, fmid}};
    ...
    static Launcher_mul kernel_mul;
    static Launcher kernel;
    typename Launcher_silu::Param args1{gp1, {activation, fin}, {w1ptr_}, {tmp1, fmid}};
...
void JblasGemmCompInt8(float* activation, jblas::storage::gemm::IWeightBase* w1ptr,
  ...
  typename Launcher_silu::Param args1{gp1, {activation, fin, &quanA1}, {w1ptr_}, blkargs1, {tmp1, fmid}};
