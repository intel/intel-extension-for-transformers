...
Only API in Section 3.Run LLM with Python Script and Advanced usage work well with "Build from source" and you can't use API in Section 2. Run LLM with Python API. If you want to use ```from_pretrain``` API, please back to main page and try to build whole project, the guide is (here)[../../../docs/installation.md].
