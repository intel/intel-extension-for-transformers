...
Once you make sure your model has the same generated tokens as PyTorch, you can deploy it by using low-bits precision like `INT4` data type. Please refer to `Python API` section for more details.
