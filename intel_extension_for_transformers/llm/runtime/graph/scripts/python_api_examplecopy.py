...
model = Model()
model.init_from_bin("llama", "/home/zhenweil/temp/ne_llama_q.bin", num_beams=1, do_sample=True, ctx_size = 512, n_discard=400, n_keep=4, seed=1234, threads=28, inf=True) # n_keep=4, ctx_size = 15, n_discard=1
# import pdb; pdb.set_trace()
