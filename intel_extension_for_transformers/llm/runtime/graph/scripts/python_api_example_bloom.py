...
model_name = "/mnt/disk1/data2/zhenweil/models/bloom/bloom-7b1"  # or local path to model
...
model = Model()
model.init_from_bin("bloom", "bloom_gptq_q4.bin", max_new_tokens=300, seed=12) # llama.q.ref.bin llama_gptq.bin
