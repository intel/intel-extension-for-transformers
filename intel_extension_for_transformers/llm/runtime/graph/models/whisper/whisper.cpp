...
static bool whisper_encode_internal(
    ...
    if (!use_coreml && !use_openvino) {
        ...
        for (int il = 0; il < n_layer; ++il) {
            ...
            // norm
            {
                ...
                cur = ne_add(ctx0,
                        ne_mul(ctx0,
                            ne_repeat(ctx0, layer.attn_ln_0_w, cur),
                            cur),
            ...
            // self-attention
            {
                ...
                struct ne_tensor * Q =
                    ne_permute(ctx0,
                            ne_cpy(ctx0,
                                Qcur,
                                ne_new_tensor_3d(ctx0, wctx.itype, n_state/n_head, n_head, n_ctx, NE_SIZE_CALC)),
                            0, 2, 1, 3);
                ...
                struct ne_tensor * Q =
                    ne_permute(ctx0,
                            ne_cpy(ctx0,
                                Qcur,
                                ne_new_tensor_3d(ctx0, NE_TYPE_F32, n_state/n_head, n_head, n_ctx, NE_SIZE_CALC)),
                            0, 2, 1, 3);
            ...
            // projection
            {
                ...
                cur = ne_add(ctx0,
                        ne_repeat(ctx0, layer.attn_ln_1_b, cur),
                        cur);
            }
            ...
            // feed-forward network
            {
                // norm
                {
                    ...
                    cur = ne_add(ctx0,
                            ne_mul(ctx0,
                                ne_repeat(ctx0, layer.mlp_ln_w, cur),
                                cur),
                ...
                cur = ggml_flash_ff(ctx0,
                        ne_cpy(ctx0, cur, ne_new_tensor_2d(ctx0, wstate.itype, n_state, n_ctx, NE_SIZE_CALC)),
                ...
                cur = ne_add(ctx0,
                        ne_repeat(ctx0, layer.mlp_0_b, cur),
                        cur);
                ...
                cur = ne_add(ctx0,
                        ne_repeat(ctx0, layer.mlp_1_b, cur),
                        cur);
#endif
            }
        ...
        // norm
        {
            ...
            cur = ne_add(ctx0,
                    ne_mul(ctx0,
                        ne_repeat(ctx0, model.e_ln_w, cur),
                        cur),
    ...
    // pre-compute cross-attention memory
    {
        ...
        for (int il = 0; il < model.hparams.n_text_layer; ++il) {
            ...
            struct ne_tensor * k = ne_view_1d(ctx0, wstate.kv_cross.k, n_state*n_ctx, (ne_element_size(wstate.kv_cross.k)*n_state)*(il*n_ctx));
...
static bool whisper_decode_internal(
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        // self-attention
        {
            ...
            struct ne_tensor * Q =
                ne_permute(ctx0,
                        ne_cpy(ctx0,
                            Qcur,
                            ne_new_tensor_3d(ctx0, NE_TYPE_F32, n_state/n_head, n_head, N, NE_SIZE_CALC)),
                        0, 2, 1, 3);

            struct ne_tensor * K =
                ne_permute(ctx0,
                        ne_reshape_3d(ctx0,
                            ne_view_1d(ctx0, kv_self.k, (n_past + N)*n_state, il*n_ctx*ne_element_size(kv_self.k)*n_state),
        ...
        // norm
        {
            ...
            cur = ne_add(ctx0,
                    ne_mul(ctx0,
                        ne_repeat(ctx0, layer.cross_attn_ln_0_w, cur),
                        cur),
        ...
        // projection
        {
            ...
            cur = ne_add(ctx0,
                    ne_repeat(ctx0, layer.cross_attn_ln_1_b, cur),
                    cur);
        }
    ...
    // norm
    {
        ...
        cur = ne_add(ctx0,
                ne_mul(ctx0,
                    ne_repeat(ctx0, model.d_ln_w, cur),
                    cur),
...
WHISPER_API const char * whisper_bench_memcpy_str(int n_threads) {
    ...
    // single-thread
    {
        ...
        for (size_t i = 0; i < n; i++) {
            const int64_t t0 = model_time_us();

            memcpy(dst, src, size);

            const int64_t t1 = model_time_us();
