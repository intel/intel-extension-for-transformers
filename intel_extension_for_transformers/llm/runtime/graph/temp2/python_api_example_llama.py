...
model_name = "/mnt/disk1/data2/zhenweil/models/mistral/neural-chat-7b-v3-1-GPTQ"  # or local path to model
# model_name = "/mnt/disk1/data2/zhenweil/models/mistral/neural-chat-7b-v3-1"
woq_config = WeightOnlyQuantConfig(compute_dtype="int8", weight_dtype="int4", use_gptq=True, use_cache=False)
