...
from intel_extension_for_transformers.llm.runtime.deprecated.compile.sub_graph.add_cls_token import (
    AddClsToken,
)
...
class TestAddClsToken(unittest.TestCase):
    ...
    def test_add_cls_token_0(self):
        ...
        transpose_node.construct(
            ...
            input_tensors=input_tensors,
            output_tensors=output_tensors,
            attr=OrderedDict({"src_perm": "0,1,2", "dst_perm": "0,2,1"}),
        )
        ...
        output_tensors = [
            Tensor(name="reshape:0", source_op=["reshape"], dest_op=["shape1"]),
        ...
        output_tensors = [
            Tensor(name="shape:1", source_op=["shape1"], dest_op=["constant_of_shape"])
        ]
        shape_node_1.construct(
            "shape1",
            "Shape",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
        ...
        output_tensors = [
            Tensor(
                name="constant_of_shape:0",
                source_op=["constant_of_shape"],
                dest_op=["mul"],
            ),
            Tensor(
                name="constant_of_shape:0",
        ...
        constant_of_shape_node.construct(
            "constant_of_shape",
            "ConstantOfShape",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
        ...
        input_tensors = [
            Tensor(name="mul:0", source_op=["mul"], dest_op=["equal"]),
            Tensor(name="reshape:0", source_op=["reshape"], dest_op=["equal"]),
        ]
        output_tensors = [
            Tensor(name="equal:0", source_op=["equal"], dest_op=["where"])
        ]
        ...
        input_tensors = [
            Tensor(name="expand:0_0", data=np.array(1), shape=[1, 1, 768]),
            Tensor(name="where:0", source_op=["where"], dest_op=["expand"]),
        ]
        output_tensors = [
            Tensor(name="expand:0", source_op=["expand"], dest_op=["concat1"])
        ]
