...
from intel_extension_for_transformers.llm.runtime.deprecated.compile.sub_graph.conv_reshape import (
    ConvReshape,
)
...
class TestConvReshape(unittest.TestCase):
    ...
    def test_conv_reshape_0(self):
        ...
        output_tensors = [
            Tensor(name="shape:0", source_op=["shape"], dest_op=["slice"])
        ]
        ...
        output_tensors = [
            Tensor(name="slice:0", source_op=["slice"], dest_op=["concat"])
        ]
