...
from intel_extension_for_transformers.llm.runtime.deprecated.compile.sub_graph.matmul_with_bias_relu import (
    MatMulWithBiasRelu,
)
...
class TestMatmulWithBiasRelu(unittest.TestCase):
    ...
    def test_matmul_with_bias_relu_1(self):
        ...
        tanh_node.construct(
            "relu", "Relu", input_tensors=input_tensors, output_tensors=output_tensors
        )
