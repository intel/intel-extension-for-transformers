...
from intel_extension_for_transformers.llm.runtime.deprecated.compile.sub_graph.decoder_attn_reshape import (
    DecoderAttnReshape,
)
...
class TestDecoderAttnReshape(unittest.TestCase):
    ...
    def test_decoder_attn_reshape(self):
        ...
        output_tensors = [
            Tensor(name="unsqueeze1:0", source_op=["unsqueeze1"], dest_op=["concat"])
        ]
        ...
        output_tensors = [
            Tensor(name="shape1:0", source_op=["shape1"], dest_op=["gather1"])
        ]
        shape1_node.construct(
            "shape1",
            "Shape",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
        ...
        output_tensors = [
            Tensor(name="gather1:0", source_op=["gather1"], dest_op=["unsqueeze2"])
        ]
        gather1_node.construct(
            "gather1",
            "Gather",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
        ...
        output_tensors = [
            Tensor(name="shape2:0", source_op=["shape2"], dest_op=["gather2"])
        ]
        shape2_node.construct(
            "shape2",
            "Shape",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
        ...
        output_tensors = [
            Tensor(name="gather2:0", source_op=["gather2"], dest_op=["unsqueeze3"])
        ]
        gather2_node.construct(
            "gather2",
            "Gather",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
        ...
        output_tensors = [
            Tensor(name="reshape:0", source_op=["reshape"], dest_op=["gather3"])
        ]
        ...
        output_tensors = [
            Tensor(name="gather3:0", source_op=["gather3"], dest_op=["transpose"])
        ]
        gather3_node.construct(
            "gather3",
            "Gather",
            input_tensors=input_tensors,
            output_tensors=output_tensors,
