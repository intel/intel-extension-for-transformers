...
from intel_extension_for_transformers.llm.runtime.deprecated.compile.extractors.extractor import (
    Extractor,
)
from intel_extension_for_transformers.llm.runtime.deprecated.compile.loaders.loader import (
    Loader,
)
from intel_extension_for_transformers.llm.runtime.deprecated.compile.sub_graph.subgraph_matcher import (
    SubGraphMatcher,
)
...
class TestPatternDispatch(unittest.TestCase):
    ...
    def test_pattern_dispatch(self):
        ...
        fp32_model_path = (
            "/tf_dataset2/inc-ut/nlptoolkit_ut_model/bert_mini_sst2_1x4_fp32.onnx"
        )
        if is_win():
            fp32_model_path = (
        ...
        fp32_output_dict = copy.deepcopy(
            fp32_model.inference([input_0, input_1, input_2])
        )
        ...
        fp32_tune_output_dict = copy.deepcopy(
            fp32_model_tune.inference([input_0, input_1, input_2])
        )
