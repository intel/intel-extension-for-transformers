...
op_maps = {
    ...
    "prim::ListConstruct": "ListConstruct",
    "aten::linear": "InnerProduct",
    "aten::slice": "Slice",
    "aten::unsqueeze": "Unsqueeze",
    "aten::rsqrt": "Rsqrt",
    "aten::masked_fill": "ConstantOfShape",
    "aten::mean": "ReduceMean",
    "aten::embedding": "Gather",
    "aten::gather": "Gather",
    "aten::where": "Where",
    "aten::matmul": "Matmul",
    ...
    "aten::size": "Shape",
    "aten::view": "View",
    "aten::permute": "Reorder",
    "aten::transpose": "Reorder",
    "aten::expand": "Expand",
    "aten::select": "Slice",
    "aten::tanh": "Tanh",
    "aten::arange": "Arange",
    ...
    "aten::lt": "Less",
    "aten::eq": "Equal",
    "aten::quantize_per_tensor": "Quantize",
    "aten::dequantize": "Dequantize",
    "prim::TupleUnpack": "TupleUnpack",
    "prim::TupleConstruct": "TupleConstruct",
    ...
    "aten::repeat": "Repeat",
    "aten::silu": "Swish",
    "prim::ListUnpack": "ListUnpack",
    "aten::ne": "NotEqual",
    "aten::div": "Div",
    "prim::padding_sequence": "PaddingSequence",
    "prim::slice_position_ids": "SlicePositionIds",
    "aten::squeeze": "Squeeze",
    "aten::baddbmm": "Baddbmm",
    "prim::mybaddbmm": "Baddbmm",
