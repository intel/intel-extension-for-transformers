...
class LastLayerShape(Pattern):
    ...
    def __call__(self, model):
            ...
            "LastLayerShape": [
                {
                    ...
                    "node_names": {0: 8, 1: 10},
                    "input_tensors": {
                        0: [[{1: [0]}, {8: [1]}, {8: [2]}], [[0, 1, 2], 3]],
                        1: [[{"input_data": [0]}], [[1], 2]],
                    },
                    "output_tensors": {0: [[], [[], 1]], 1: [[{10: [0]}], [[0], 1]]},
                    "returns": [8, 9],
                },
                {
                    "patterns": {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: 1, 1: 2, 2: 3},
                    "input_tensors": {
                        0: [[{1: [0]}, {"input_data": [0]}], [[0, 1], 2]],
                        1: [[], [[], 1]],
                        2: [[], [[], 1]],
                    },
                    "output_tensors": {
                ...
                # roberta_base / distil_bert_base
                {
                    "patterns": {
                        "in": [
                            [(0, "LayerNorm"), (1, "Gather"), (2, "MatMulWithBias")]
                        ],
                        "out": [
                            [
                                (0, "LayerNorm"),
        ...
        model, new_node_names, ret_old_nodes = util.pattern_mapping(
            "LastLayerShape", pattern_dict, model
        )
