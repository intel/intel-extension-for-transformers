...
class InputData(Pattern):
    ...
    def __call__(self, model):
            ...
            "InputData": [
                {
                    "patterns": {
                        "in": [
                            [(0, "input_ids"), (1, "segment_ids"), (2, "input_mask")]
                        ],
                        "out": [[(0, "Input")]],
                    },
                    "search_mode": "node_name",
                    "node_names": {0: "input_data"},
                    "input_tensors": {0: [[], [[], 0]]},
                    "output_tensors": {
                        0: [[{0: [0]}, {1: [0]}, {2: [0]}], [[0, 1, 2], 3]]
                    },
                    "returns": [0, 1, 2],
                },
                ...
                # distil_bert_base
                {
                    ...
                    "node_names": {0: "input_data"},
                    "input_tensors": {0: [[], [[], 0]]},
                    "output_tensors": {0: [[{0: [0]}, {1: [0]}], [[0, 1], 2]]},
                    "returns": [],
                },
                # stale diffusion text encdoer
                {
                    "patterns": {"in": [[(0, "input_ids")]], "out": [[(0, "Input")]]},
                    "search_mode": "node_name",
                    "node_names": {0: "input_data"},
                    "input_tensors": {0: [[], [[], 0]]},
                    "output_tensors": {0: [[{0: [0]}], [[], 1]]},
                    "returns": [],
                },
        ...
        if model.nodes[0].op_type != "Input":
            ...
            input_data_node = util.construct_node(
