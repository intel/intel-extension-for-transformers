            ...
            "PaddingSequence": [
                {
                    ...
                    "node_names": {0: 10},
                    "input_tensors": {
                        0: [[{10: [0]}, {"padding_sequence": [0]}], [[0, 1], 2]]
                    },
                    "output_tensors": {0: [[{10: [0]}], [[0], 1]]},
                    "returns": [],
                },
                # bert_base_mrpc
                {
                    ...
                    "node_names": {0: 11},
                    "input_tensors": {
                        0: [[{11: [0]}, {"padding_sequence": [0]}], [[0, 1], 2]]
                    },
                    "output_tensors": {0: [[{11: [0]}], [[0], 1]]},
                    "returns": [],
                },
                # geminet, bert_related in huggingface
                {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: 4},
                    "input_tensors": {0: [[{"input_data": [-1]}], [[0], 1]]},
                ...
                # distil_bert_base
                {
                    ...
                    "node_names": {0: 8},
                    "input_tensors": {
                        0: [[{5: [0]}, {"padding_sequence": [0]}], [[0, 1], 2]]
                    },
                ...
                # distil_bert_base_int8
                {
                    ...
                    "node_names": {0: 4},
                    "input_tensors": {
                        0: [[{6: [0]}, {"padding_sequence": [0]}], [[0, 1], 2]]
                    },
                    "output_tensors": {0: [[{4: [0]}], [[0], 1]]},
                    "returns": [5],
                },
                # opennmt encoder
                {
                    ...
                    "node_names": {0: 13},
                    "input_tensors": {
                        0: [[{13: [2]}, {"padding_sequence": [0]}], [[0, 1], 2]]
                    },
                    "output_tensors": {0: [[{13: [0]}], [[0], 1]]},
                    "returns": [0],
                },
                # opennmt decoder
                {
                    ...
                    "node_names": {0: 14},
                    "input_tensors": {
                        0: [[{14: [2]}, {"padding_sequence": [0]}], [[0, 1], 2]]
                    },
                    "output_tensors": {0: [[{14: [0]}], [[0], 1]]},
                    "returns": [0],
                },
            ]
        }

        def _make_padding_sequence_node(
            tensor_idx, hidden_size, model, seq_len_first=False
        ):
            ...
            output_tensors = [
                Tensor(name=node_name + ":0", source_op=[node_name], dest_op=[])
            ]
            attr = OrderedDict()
            ...
            padding_sequence_node = util.construct_node(
                node_name,
                "PaddingSequence",
