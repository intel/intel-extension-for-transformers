...
class AttentionMaskLengthAdaptiveExpandIndices(Pattern):
    ...
    def __call__(self, model):
        ...
        # minilmv2-lat-roberta
        for idx, pattern_dict in enumerate(
            pattern_mapping_config["AttentionMaskLengthAdaptiveExpandIndices"]
        ):
            model, new_node_names, ret_old_nodes = util.pattern_mapping(
                "AttentionMaskLengthAdaptiveExpandIndices", pattern_dict, model
            )
