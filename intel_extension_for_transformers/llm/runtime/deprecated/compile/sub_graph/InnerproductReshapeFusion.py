    ...
    def __call__(self, model):
            ...
            "InnerproductReshapeFusion": [
                {
                    ...
                    "node_names": {0: 0},
                    "input_tensors": {
                        0: [[{0: [0]}, {0: [1]}, {"input_data": [0]}], [[0, 1, 2], 3]]
                    },
                ...
                },
                {
                    "patterns": {
                        "in": [
                            [(0, "InnerProduct"), (1, "View"), (2, "Reorder")],
                        ],
        ...
        def _set_attr1(new_node_names, ret_old_nodes, model):
            for i in range(len(new_node_names)):
                ...
                if len(ret_mat_node.input_tensors) == 3:
                    model.nodes[mat_node_idx].input_tensors.insert(
                        -1, copy.deepcopy(ret_mat_node.input_tensors[-1])
                    )
                attr = OrderedDict()
        ...
        if model.framework_modeling_config["framework"] == "torch":
            ...
            model, new_node_names, ret_old_nodes = util.pattern_mapping(
                "InnerproductReshapeFusion", pattern_dict, model
            )
