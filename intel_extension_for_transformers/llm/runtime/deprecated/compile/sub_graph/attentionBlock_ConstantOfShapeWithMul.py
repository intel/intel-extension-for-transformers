...
class AttentionBlock_ConstantOfShapeWithMul(Pattern):
    ...
    def __call__(self, model):
        ...
        pattern = pattern_mapping_config["AttentionBlock_ConstantOfShapeWithMul"][0][
            "patterns"
        ]["in"]
        ...
        if len(patterns_nodes_name) != 0:
            ...
            logger.debug(
                "AttentionBlock_ConstantOfShapeWithMul = {}".format(patterns_nodes_name)
            )
        ...
        if mul == 0:
            ...
            if len(new_node_names) != 0:
                logger.info("AttentionBlock_ConstantOfShapeWithMul matched...")
                logger.debug(
                    "AttentionBlock_ConstantOfShapeWithMul = {}".format(
                        patterns_nodes_name
                    )
                )
