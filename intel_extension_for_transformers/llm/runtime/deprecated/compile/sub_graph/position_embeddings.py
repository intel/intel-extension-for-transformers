    ...
    def __call__(self, model):
            ...
            "PositionEmbeddings": [
                {
                    "patterns": {
                        "in": [
                            ...
                            [(1, "StridedSlice"), (4, "Pack"), (5, "Reshape")],
                        ],
                        "out": [[(0, "Reshape"), (1, "Reshape")]],
                    },
                    "search_mode": "op_type",
                    "node_names": {0: "position_embeddings/after/reshape", 1: 5},
                    "input_tensors": {
                        0: [[{3: [0]}, {"input_data": [0]}], [[0, 1], 2]],
                        1: [[], [[], 1]],
                    },
                    "output_tensors": {0: [[], [[], 1]], 1: [[{5: [0]}], [[0], 1]]},
                    "returns": [3],
                },
                # distil_bert_base
                {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: "position_embeddings/after/reshape", 1: 7},
                    "input_tensors": {
                        0: [[{7: [0]}, {"input_data": [0]}], [[0, 1], 2]],
                        1: [[], [[], 1]],
                    },
                    "output_tensors": {0: [[], [[], 1]], 1: [[{7: [0]}], [[0], 1]]},
                    "returns": [7],
                },
                # geminet
                {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: "position_embeddings/after/reshape", 1: 15},
                    "input_tensors": {
                        0: [[{15: [0]}, {"input_data": [0]}], [[0, 1], 2]],
                        1: [[], [[], 1]],
                    },
                    "output_tensors": {0: [[], [[], 1]], 1: [[{15: [0]}], [[0], 1]]},
                    "returns": [15],
                },
                # bert_base_sparse
                {
                ...
                # bert_mini_int8
                {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: "position_embeddings/after/reshape", 1: 4},
                    "input_tensors": {
                        0: [[{4: [0]}, {"input_data": [0]}], [[0, 1], 2]],
                        1: [[], [[], 1]],
                    },
                    "output_tensors": {0: [[], [[], 1]], 1: [[{4: [0]}], [[0], 1]]},
                    "returns": [4],
                },
                # opennmt encoder
                {
                ...
                # bert_base_mrpc
                {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: "position_embeddings/after/reshape", 1: 1},
                    "input_tensors": {
                        0: [[{0: [0]}, {"input_data": [0]}], [[0, 1], 2]],
                        1: [[], [[], 1]],
                    },
        ...
        for i in range(0, len(pattern_mapping_config["PositionEmbeddings"]) - 1):
            ...
            model, new_node_names, ret_old_nodes = util.pattern_mapping(
                "PositionEmbeddings", pattern_dict, model
            )
            if len(new_node_names) != 0:
                for j in range(len(new_node_names)):
                    ...
                    batch_idx = 0
                    if (
                        model.get_node_by_name(new_node_names[j][0]).op_type
                        == "Reshape"
                        and model.get_node_by_name(new_node_names[j][1]).op_type
                        != "Reshape"
                    ):
                        batch_idx = 1
                    _set_attr(
                        hidden_size, new_node_names[j], model, batch_idx=batch_idx
                    )
