        ...
        pattern_mapping_config = {
            "LayerNorm": [
                # bert_base has two layer_norm patterns
                {
                    ...
                    "node_names": {0: 16},
                    "input_tensors": {
                        0: [[{0: [0]}, {15: [1]}, {16: [1]}], [[0, 1, 2], 3]]
                    },
                    "output_tensors": {0: [[{16: [0]}], [[0], 1]]},
                    "returns": [13],
                },
                {
                    "patterns": {
                ...
                },
                {
                    ...
                    "node_names": {0: 9},
                    "input_tensors": {
                        0: [[{0: [0]}, {5: [1]}, {8: [0]}], [[0, 1, 2], 3]]
                    },
                    "output_tensors": {0: [[{9: [0]}], [[0], 1]]},
                    "returns": [3],
                },
                # distil_bert_base
                {
