...
class RoraryPosEmb(Pattern):
    ...
    def __call__(self, model):
        ...
        pattern_mapping_config = {
            "RoraryPosEmb": [
                ...
                },
                {
                    "patterns": {
                        "in": [
                            [(0, "Add"), (1, "Slice"), (2, "Unsqueeze"), (3, "Slice")]
                        ],
                    ...
                    "input_tensors": {
                        0: [[{1: [0]}], [[0], 1]],
                        1: [[{"input_data": [2]}, {"input_data": [0]}], [[1, 2], 3]],
                    },
                    "output_tensors": {0: [[], [[], 1]], 1: [[{3: [0]}], [[0], 1]]},
                    "returns": [0],
                },
                {
                    "patterns": {
                    ...
                    "search_mode": "op_type",
                    "node_names": {0: 3, 1: 4, 2: 0, 3: 5, 4: 6},
                    "input_tensors": {
                        0: [[{0: [0]}], [[0], 1]],
                        1: [[], [[], 1]],
                        2: [[], [[], 1]],
                ...
                },
                {
                    ...
                    "input_tensors": {
                        0: [[{"input_data": [0]}, {"input_data": [2]}], [[0, 1], 2]]
                    },
        ...
        model, new_node_names, ret_old_nodes = util.pattern_mapping(
            "RoraryPosEmb", pattern_dict, model
        )
        ...
        def _set_attr1(new_node_names, ret_old_nodes, model):
            ...
            for i in range(len(new_node_names)):
                ...
                slice_node.attr = OrderedDict(
                    {
                        "starts_with_tensor": "1",
                        "ends_add": "1",
                        "axes": "1",
                        "steps": "1",
                    }
        ...
        def _set_attr2(new_node_names, ret_old_nodes, model):
            for i in range(len(new_node_names)):
                ...
                old_slice_node = model.get_node_by_name(
                    ret_old_nodes[i][0].input_tensors[0].source_op[0]
                )
                concat_node = model.get_node_by_name(new_node_names[i][3])
                first_slice_node = model.get_node_by_name(
                    concat_node.input_tensors[1].source_op[0]
                )
                ...
                reshape_output = Tensor(
                    name=concat_node.input_tensors[1].name + "_reshape",
