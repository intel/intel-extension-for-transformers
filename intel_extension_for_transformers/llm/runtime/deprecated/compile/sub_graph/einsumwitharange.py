...
class EinsumwithArange(Pattern):
    ...
    def __call__(self, model):
        ...
        pattern_mapping_config = {
            "EinsumwithArange": [
                ...
                },
                {
                    "patterns": {
                        "in": [
                            [(0, "Shape"), (2, "Add"), (3, "Arange"), (4, "Einsum")],
                            [(), (1, "Shape"), (2, "Add")],
                        ],
                        "out": [[(0, "Range"), (1, "Reshape"), (2, "Matmul")]],
                    },
                    "search_mode": "op_type",
                    "node_names": {0: 3, 1: 0, 2: 4},
                    "input_tensors": {
        ...
        def _set_attr(new_node_names, ret_old_nodes, model):
            for i in range(len(new_node_names)):
                ...
                reshape_output = Tensor(
                    name=reshape_node.input_tensors[0].name + "_reshape",
                ...
                range_2 = model.get_node_by_name(
                    matmul_node.input_tensors[1].source_op[0]
                )
        ...
        model, new_node_names, ret_old_nodes = util.pattern_mapping(
            "EinsumwithArange", pattern_dict, model
        )
