...
# print(raw_wei)
trans_raw_wei=torch.rand(2,32,dtype=torch.float)
...
trans_dst = torch.zeros(1,2,dtype=torch.float)
...
torch.ops.weight_only_jblasop.jblas_quantweight_f32_linear(activation,trans_quant_wei,trans_dst,1,2,32,32,2)
