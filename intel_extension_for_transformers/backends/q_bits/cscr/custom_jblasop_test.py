...
print("==========bias========")
print(bias)
torch.ops.weight_only_jblasop.jblas_quantweight_f32_linear(activation,trans_quant_wei,bias,trans_dst,2,3,32,32,3,True)
print("==============transformat with bias result===============")
print(trans_dst)
print("~~~~~~~~~~~~~~~~~~")
print(trans_correct+bias)
torch.ops.weight_only_jblasop.jblas_quantweight_f32_linear(activation,trans_quant_wei,bias,trans_dst,2,3,32,32,3,False)
