...
bool mha_dense_dynamic_bench::check_result() {
  ...
  std::shared_ptr<const kernel_desc_t> mha_dense_ref_desc;
  kernel_desc_t::create<mha_dense_ref_kd_t>(mha_dense_ref_desc, q.op_desc);
  std::shared_ptr<const kernel_t> mha_dense_dynamic_ref_kernel;
  kernel_t::create<mha_dense_ref_k_t, mha_dense_ref_kd_t>(mha_dense_dynamic_ref_kernel, mha_dense_ref_desc);
