...
void transpose_mha_bench::gen_case() {
  ...
  const tensor_desc src_k_desc = {spmm_shape, data_type::s8, format_type::undef};
  const tensor_desc src_q_desc = {spmm_shape, data_type::s8, format_type::undef};
  const tensor_desc mask_desc = {spmm_shape, data_type::fp32, format_type::undef};
  const tensor_desc src_v_desc = {spmm_shape, data_type::s8, format_type::undef};
  const tensor_desc dst_desc = {spmm_shape, data_type::u8, format_type::undef};
  ...
  operator_desc op_desc(kernel_kind::transpose_mha, kernel_prop::forward_inference, engine_kind::cpu, ts_descs,
                        op_attrs);
