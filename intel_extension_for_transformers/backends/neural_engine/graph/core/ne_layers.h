...
extern "C" {
    ...
    NE_API struct ne_tensor * ne_new_tensor(
            struct ne_context * ctx,
            enum   ne_type type,
            int    n_dims,
            const int64_t *ne);

    NE_API struct ne_tensor * ne_new_tensor_1d(
            struct ne_context * ctx,
            enum   ne_type type,
            int64_t ne0);

    NE_API struct ne_tensor * ne_new_tensor_2d(
            struct ne_context * ctx,
            enum   ne_type type,
            int64_t ne0,
            int64_t ne1);

    NE_API struct ne_tensor * ne_new_tensor_3d(
            struct ne_context * ctx,
            enum   ne_type type,
            int64_t ne0,
            int64_t ne1,
    ...
    NE_API struct ne_tensor * ne_new_tensor_4d(
            struct ne_context * ctx,
            enum   ne_type type,
            int64_t ne0,
            int64_t ne1,
    ...
    NE_API struct ne_tensor * ne_dup(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_add(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_add_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_add1(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_acc(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                nb1,
    ...
    NE_API struct ne_tensor * ne_acc_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                nb1,
    ...
    NE_API struct ne_tensor * ne_sub(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_mul(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_div(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_sqr(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_sqrt(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_log(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_log_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // return scalar
    NE_API struct ne_tensor * ne_sum(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // sums along rows, with input shape [a,b,c,d] return shape [1,b,c,d]
    NE_API struct ne_tensor * ne_sum_rows(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // mean along rows
    NE_API struct ne_tensor * ne_mean(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // if a is the same shape as b, and a is not parameter, return a
    // otherwise, return a new tensor: repeat(a) to fit in b
    NE_API struct ne_tensor * ne_repeat(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_abs(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_sgn(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_neg(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_step(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_relu(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // TODO: double-check this computation is correct
    NE_API struct ne_tensor * ne_gelu(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_silu(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // a - x
    // b - dy
    NE_API struct ne_tensor * ne_silu_back(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);
    ...
    NE_API struct ne_tensor * ne_norm(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_rms_norm(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // a - x
    // b - dy
    NE_API struct ne_tensor * ne_rms_norm_back(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);
    ...
    NE_API struct ne_tensor * ne_mul_mat(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);
    ...
    NE_API struct ne_tensor * ne_scale(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    // in-place, returns view(a)
    NE_API struct ne_tensor * ne_scale_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    // b -> view(a,offset,nb1,nb2,3), return modified a
    NE_API struct ne_tensor * ne_set(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                nb1,
    ...
    NE_API struct ne_tensor * ne_set_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                nb1,
    ...
    NE_API struct ne_tensor * ne_set_1d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                offset);

    NE_API struct ne_tensor * ne_set_1d_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                offset);
    ...
    // b -> view(a,offset,nb1,nb2,3), return modified a
    NE_API struct ne_tensor * ne_set_2d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                nb1,
    ...
    // b -> view(a,offset,nb1,nb2,3), return view(a)
    NE_API struct ne_tensor * ne_set_2d_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            size_t                nb1,
    ...
    // a -> b, return view(b)
    NE_API struct ne_tensor * ne_cpy(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    // make contiguous
    NE_API struct ne_tensor * ne_cont(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // return view(a), b specifies the new shape
    // TODO: when we start computing gradient, make a copy instead of view
    NE_API struct ne_tensor * ne_reshape(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);
    ...
    // return view(a)
    // TODO: when we start computing gradient, make a copy instead of view
    NE_API struct ne_tensor * ne_reshape_1d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0);

    NE_API struct ne_tensor * ne_reshape_2d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            int64_t               ne1);
    ...
    // return view(a)
    // TODO: when we start computing gradient, make a copy instead of view
    NE_API struct ne_tensor * ne_reshape_3d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            int64_t               ne1,
    ...
    NE_API struct ne_tensor * ne_reshape_4d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            int64_t               ne1,
    ...
    // offset in bytes
    NE_API struct ne_tensor * ne_view_1d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            size_t                offset);

    NE_API struct ne_tensor * ne_view_2d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            int64_t               ne1,
    ...
    NE_API struct ne_tensor * ne_view_3d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            int64_t               ne1,
    ...
    NE_API struct ne_tensor * ne_view_4d(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int64_t               ne0,
            int64_t               ne1,
    ...
    NE_API struct ne_tensor * ne_permute(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   axis0,
            int                   axis1,
    ...
    NE_API struct ne_tensor * ne_transpose(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    NE_API struct ne_tensor * ne_get_rows(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_get_rows_back(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b,
            struct ne_tensor  * c);

    NE_API struct ne_tensor * ne_diag(
        struct ne_context     * ctx,
        struct ne_tensor      * a);

    // set elements above the diagonal to -INF
    NE_API struct ne_tensor * ne_diag_mask_inf(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past);

    // in-place, returns view(a)
    NE_API struct ne_tensor * ne_diag_mask_inf_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past);

    // set elements above the diagonal to 0
    NE_API struct ne_tensor * ne_diag_mask_zero(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past);

    // in-place, returns view(a)
    NE_API struct ne_tensor * ne_diag_mask_zero_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past);

    NE_API struct ne_tensor * ne_soft_max(
            struct ne_context * ctx,
            struct ne_tensor  * a);

    // in-place, returns view(a)
    NE_API struct ne_tensor * ne_soft_max_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a);
    ...
    NE_API struct ne_tensor * ne_rope(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past,
            int                   n_dims,
    ...
    // in-place, returns view(a)
    NE_API struct ne_tensor * ne_rope_inplace(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past,
            int                   n_dims,
    ...
    // a - dy
    NE_API struct ne_tensor * ne_rope_back(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            int                   n_past,
            int                   n_dims,
    ...
    //       not great ..
    NE_API struct ne_tensor * ne_conv_1d_1s(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_conv_1d_2s(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b);

    NE_API struct ne_tensor * ne_flash_attn(
            struct ne_context * ctx,
            struct ne_tensor  * q,
            struct ne_tensor  * k,
            struct ne_tensor  * v,
    ...
    NE_API struct ne_tensor * ne_flash_ff(
            struct ne_context * ctx,
            struct ne_tensor  * a,
            struct ne_tensor  * b0,
            struct ne_tensor  * b1,
    ...
    NE_API struct ne_tensor * ne_map_unary_f32(
            struct ne_context        * ctx,
            struct ne_tensor         * a,
                   ne_unary_op_f32_t   fun);

    NE_API struct ne_tensor * ne_map_binary_f32(
            struct ne_context         * ctx,
            struct ne_tensor          * a,
            struct ne_tensor          * b,
    ...
    NE_API enum ne_opt_result ne_opt(
            struct ne_context * ctx,
            struct ne_opt_params params,
            struct ne_tensor * f);
