...
if len(sys.argv) < 3:
    print("Usage: python convert-hf-to-ne.py model_name dir-output [use-f32]")
...
fn_bin = f"/ne-{model_name.split('/')[-2]}-{ftype_str[ftype]}.bin"
fn_out = dir_out + "/ne-" + ftype_str[ftype] + ".bin"
fout = open(fn_out, "wb")
