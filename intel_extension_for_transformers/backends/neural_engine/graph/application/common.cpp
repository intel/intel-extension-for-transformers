...
static const std::map<std::string, enum ne_ftype> NE_FTYPE_MAP = {
    {"q4_0", NE_FTYPE_MOSTLY_Q4_0},
    {"q4_1", NE_FTYPE_MOSTLY_Q4_1},
    {"q5_0", NE_FTYPE_MOSTLY_Q5_0},
    {"q5_1", NE_FTYPE_MOSTLY_Q5_1},
    {"q8_0", NE_FTYPE_MOSTLY_Q8_0},
};
...
bool ne_common_quantize_0(
    ...
    switch (ftype) {
        ...
        case NE_FTYPE_MOSTLY_Q4_1: qtype = NE_TYPE_Q4_1; break;
        case NE_FTYPE_MOSTLY_Q5_0: qtype = NE_TYPE_Q5_0; break;
        case NE_FTYPE_MOSTLY_Q5_1: qtype = NE_TYPE_Q5_1; break;
        case NE_FTYPE_MOSTLY_Q8_0: qtype = NE_TYPE_Q8_0; break;
