...
int main(int argc, char** argv) {
  ...
  // uncomment the "used_mem" line in starcoder.cpp to see the results
  if (params.mem_test) {
    {
  ...
  // Add a space in front of the first character to match OG starcoder tokenizer behavior
