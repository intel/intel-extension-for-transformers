> [Original](https://github.com/ggerganov/llama.cpp/blob/master/examples/main/README.md) of this documents.
...
```bash
./build/bin/main_llama -m ${path_to_models} --prompt "Once upon a time"
```
