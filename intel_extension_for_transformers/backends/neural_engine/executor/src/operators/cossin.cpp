...
#define PS256_CONST(Name, Val)                                      \
    static constexpr v8sf ps256_##Name __attribute__((aligned(32))) = { Val, Val, Val, Val, Val, Val, Val, Val }
#define PI32_CONST256(Name, Val)                                    \
    static constexpr __m256i pi256_##Name __attribute__((aligned(32))) = \
    (__m256i)(v8si) { Val, Val, Val, Val, Val, Val, Val, Val }
...
PI32_CONST256(sign_mask, (int)0x80000000);
...
__m256 sinf(__m256 x) {
    ...
    x = _mm256_and_ps(x, (__m256)pi256_inv_sign_mask);
    // extract the sign bit (upper one)
    sign_bit = _mm256_and_ps(sign_bit, (__m256)pi256_sign_mask);
    ...
    __m256 swap_sign_bit = (__m256)imm0;
