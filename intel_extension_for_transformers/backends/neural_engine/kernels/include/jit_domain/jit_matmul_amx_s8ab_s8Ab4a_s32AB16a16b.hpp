...
#ifndef ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_MATMUL_AMX_S8AB_S8AB4A_S32AB16A16B_HPP_
#define ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_MATMUL_AMX_S8AB_S8AB4A_S32AB16A16B_HPP_
 ...
 public:
  ...
  explicit jit_matmul_amx_s8ab_s8Ab4a_s32AB16a16b(const jit_matmul_amx_s8ab_s8Ab4a_s32AB16a16b::param_t& param)
      : jit_generator(),
        ...
        required_amx_cfg_(16, 16, K, false, 4) {
    SPARSE_LOG_IF(ERROR, K > ld_src0) << "K > ld_src0 which may lead to unexpected behavior!";
    SPARSE_LOG_IF(FATAL, K > 64) << "Currently only support K <= 64";
...
#endif  // ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_MATMUL_AMX_S8AB_S8AB4A_S32AB16A16B_HPP_
