...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_GATHER_REF_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_GATHER_REF_HPP_
...
class gather_ref_kd_t : public kernel_desc_t {
 public:
  explicit gather_ref_kd_t(const jd::operator_desc& op_desc) : kernel_desc_t(kernel_kind::gather), op_desc_(op_desc) {}
...
#endif  // ENGINE_SPARSELIB_INCLUDE_KERNELS_GATHER_REF_HPP_
