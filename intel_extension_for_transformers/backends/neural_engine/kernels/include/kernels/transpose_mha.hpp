...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_TRANSPOSE_MHA_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_TRANSPOSE_MHA_HPP_
...
class transpose_mha_kd_t : public kernel_desc_t {
 public:
  explicit transpose_mha_kd_t(const jd::operator_desc& op_desc)
...
#endif  // ENGINE_SPARSELIB_INCLUDE_KERNELS_TRANSPOSE_MHA_HPP_
