...
class mha_dense_kd_t : public kernel_desc_t {
 ...
 public:
  ...
  inline std::vector<dim_t> shape() const override { return op_desc_.tensor_descs().back().shape(); }
...
class mha_dense_k_t : public kernel_t {
 ...
 private:
  ...
  jit_softmax_Ab16a* ker_softmax_[7][16];
  jit_matmul_amx_s8ab_s8Ab4a_s32AB16a16b* ker_qk_gemm_16x_[25];
  jit_matmul_amx_s8ab_s8Ab4a_s32AB16a16b* ker_qk_gemm_32x_[25];
  jit_matmul_amx_u8AB16a64b_s8BA16b4a_ab* ker_av_gemm_16x_[7];
  jit_matmul_amx_u8AB16a64b_s8BA16b4a_ab* ker_av_gemm_32x_[7];
