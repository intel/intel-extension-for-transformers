...
#ifndef ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_DYNAMIC_QUANT_MHA_HPP_
#define ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_DYNAMIC_QUANT_MHA_HPP_
...
#endif  // ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_DYNAMIC_QUANT_MHA_HPP_
