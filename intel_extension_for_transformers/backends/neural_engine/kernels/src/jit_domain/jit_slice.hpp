...
#ifndef ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_SLICE_HPP_
#define ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_SLICE_HPP_
...
#endif  // ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_SLICE_HPP_
