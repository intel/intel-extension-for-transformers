...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_GROUPNORM_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_GROUPNORM_HPP_
...
#endif  // ENGINE_SPARSELIB_INCLUDE_KERNELS_GROUPNORM_HPP_
