...
#ifndef ENGINE_SPARSELIB_INCLUDE_DATA_PACK_HPP_
#define ENGINE_SPARSELIB_INCLUDE_DATA_PACK_HPP_
...
void reference(
    ...
    std::function<dst_t(src_t)> cast_func = [](src_t x) -> dst_t { return cast_to<dst_t, src_t>(x); }) {
...
#endif  // ENGINE_SPARSELIB_INCLUDE_DATA_PACK_HPP_
