...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_matmul_AVX512F_8BIT_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_matmul_AVX512F_8BIT_HPP_
...
#include "jit_domain/jit_gemm_avx512f_8bit.hpp"
#include "kernel.hpp"
...
class matmul_avx512f_8bit_kd_t : public kernel_desc_t {
 public:
  ...
  explicit matmul_avx512f_8bit_kd_t(const jd::operator_desc& op_desc)
...
#endif  // ENGINE_SPARSELIB_INCLUDE_KERNELS_matmul_AVX512F_8BIT_HPP_
