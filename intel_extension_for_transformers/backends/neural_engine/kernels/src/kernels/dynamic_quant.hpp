...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_HPP_
...
class dynamic_quant_kd_t : public kernel_desc_t {
 public:
  explicit dynamic_quant_kd_t(const jd::operator_desc& op_desc)
...
#endif  // ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_HPP_
