 ...
 */
namespace {
std::unordered_map<jd::data_type, size_t> type2bytes = {{jd::data_type::u8, 1},   {jd::data_type::s8, 1},
                                                        {jd::data_type::fp16, 2}, {jd::data_type::bf16, 2},
                                                        {jd::data_type::fp32, 4}, {jd::data_type::s32, 4}};
enum SubKernel {
  QK_SPMM = 0,
  Q_K_GEMM = 1,
  SOFTMAX = 2,
