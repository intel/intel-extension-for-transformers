...
namespace jd {
static const std::map<kernel_prop, std::vector<impl_list_item_t>> mha_dense_impl_list_map = {
    {kernel_prop::forward_inference, {CPU_INSTANCE(mha_dense_k_t), CPU_INSTANCE(mha_dense_ref_k_t), NULL_INSTANCE()}},
};
