...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_REF_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_REF_HPP_
...
class SPARSE_API_ dynamic_quant_ref_kd_t : public kernel_desc_t {
 public:
  explicit dynamic_quant_ref_kd_t(const jd::operator_desc& op_desc)
...
class SPARSE_API_ dynamic_quant_ref_k_t : public kernel_t {
 public:
  using kd_t = dynamic_quant_ref_kd_t;
  explicit dynamic_quant_ref_k_t(const std::shared_ptr<const kd_t>& kd) : kernel_t(kd) {}
