...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_MATMUL_REF_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_MATMUL_REF_HPP_
...
#endif  // ENGINE_SPARSELIB_INCLUDE_KERNELS_DYNAMIC_QUANT_MATMUL_REF_HPP_
