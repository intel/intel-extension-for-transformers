...
cp itrex/intel_extension_for_transformers/transformers/llm/runtime/deprecated/CMakeLists.txt .
cp itrex/intel_extension_for_transformers/transformers/llm/runtime/deprecated/executor/src/nlp_executor.cc neural_engine_example.cc
```
Modify the NE_ROOT in the CmakeLists.txt.
```cmake
set(NE_ROOT "${PROJECT_SOURCE_DIR}/itrex/intel_extension_for_transformers/transformers/llm/runtime/deprecated")
```
