...
class H2OGPTNeoXForCausalLM(GPTNeoXPreTrainedModel):
    _tied_weights_keys = ["embed_out.weight"]

    def __init__(self, config, h2o_config):
        ...
        for layer_idx in range(num_layers):
            module = self.gpt_neox.layers[layer_idx].self_attn
            cls_name = module.__class__.__name__
            if cls_name == "GPTNeoXFlashAttention2":
