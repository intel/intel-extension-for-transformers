...
#include "../../include/operators/cossin.hpp"
...
bool CheckResult(const TestParams& t) {
  ...
  try {
    executor::CosSinOperator CosSin(p.conf);
    CosSin.Reshape(p.input, p.output);
    CosSin.Forward(p.input, p.output);
...
class CosSinTest : public testing::TestWithParam<TestParams> {
 protected:
  CosSinTest() {}
  ~CosSinTest() {}
  void SetUp() override {}
