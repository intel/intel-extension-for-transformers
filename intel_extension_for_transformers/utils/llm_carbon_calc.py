...
def main():
    parser = argparse.ArgumentParser(
        description="LLM carbon calculator - "
    ...
    parser.add_argument(
        ...
        type=float,
        metavar="T",
        help="total time of one inference procedure" "in mini-seconds",
    )
    parser.add_argument(
        "--fl",
        "--first-latency",
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="TDP",
        help="device TDP in Watts, it could be " "CPU/GPU/Accelerators",
    )
    parser.add_argument(
        "-m",
        "--mem",
    ...
    if args.time is not None:
        ...
        print(
            "You need to specify either total time of "
