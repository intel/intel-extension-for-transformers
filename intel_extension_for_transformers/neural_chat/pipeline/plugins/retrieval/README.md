...
override [bool]: Decide to use the local database or not. If override=True, the uploaded files will be continuously written into the database. If override=False, the existing database will be loaded.
