...
from intel_extension_for_transformers.langchain.retrievers import (
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.retrieval_type == "default":
            ...
            self.retriever = ChildParentRetriever(
                parentstore=document_store, vectorstore=child_document_store, **kwargs
            )  # pylint: disable=abstract-class-instantiated
        else:
            logging.error(
                "The chosen retrieval type remains outside the supported scope."
            )
