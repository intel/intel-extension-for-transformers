...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            default=float("inf"),
            help=(
                "Maximum number of samples allowed per dataset. If the dataset directory contains more than"
        ...
        parser.add_argument(
            ...
            help=(
                "scaling and cropping of images at load time [shift_scale_rot_flip | shift_scale | shift |"
                " shift_rot_flip ]"
            ),
        )
        parser.add_argument(
