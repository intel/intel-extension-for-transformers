...
from intel_extension_for_transformers.neural_chat.pipeline.plugins.audio.utils.split_audio import (
    main,
)
...
class TestSplitAudio(unittest.TestCase):
    ...
    def test_split_audio(self):
        ...
        if os.path.exists(audio_path):
            ...
            parser.add_argument(
                "--in_path", type=str, default="../assets/audio/sample.wav"
            )
        parser.add_argument(
        ...
        if os.path.exists(audio_path):
            audio_path_prefix = "/intel-extension-for-transformers/intel_extension_for_transformers/neural_chat/assets/audio"
