...
from intel_extension_for_transformers.neural_chat.pipeline.plugins.audio.utils.video_to_wav import (
...
class TestVideo2Wav(unittest.TestCase):
    def setUp(self):
        video_path = "/intel-extension-for-transformers/intel_extension_for_transformers/neural_chat/assets/video/"
    ...
    def test_video_to_wav_file(self):
        ...
        video_path = "/intel-extension-for-transformers/intel_extension_for_transformers/neural_chat/assets/video/intel.mp4"
        if os.path.exists(video_path):
        ...
        if os.path.exists(video_path):
            video_path_prefix = "/intel-extension-for-transformers/intel_extension_for_transformers/neural_chat/assets/video/"
