...
from intel_extension_for_transformers.neural_chat.pipeline.plugins.audio.finetuning.tts_finetuning import (
    TTSFinetuning,
)

workdir = os.getcwd()
data_args = TTSDatasetArguments(
    audio_folder_path=os.path.join(workdir, "audios"),
