...
def maybe_zero_3(param, ignore_status=False, name=None):
    ...
    from deepspeed.runtime.zero.partition_parameters import ZeroParamStatus # pylint: disable=E0401
...
def get_modality_length_grouped_indices(lengths, batch_size, world_size, generator=None):
    ...
    lang_shuffle = [lang_indices[i] for i in get_length_grouped_indices(lang_lengths,
        batch_size, world_size, generator=None)]
    ...
    def __iter__(self):
        if self.group_by_modality:
            indices = get_modality_length_grouped_indices(self.lengths,
                    self.batch_size, self.world_size, generator=self.generator)
        else:
...
if is_hpu_available:
    ...
    class GaudiLLaVATrainer(GaudiTrainer):
