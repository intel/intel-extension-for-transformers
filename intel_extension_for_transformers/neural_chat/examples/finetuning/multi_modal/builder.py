...
from intel_extension_for_transformers.transformers.modeling.llava_models.llava_llama import LlavaLlamaForCausalLM
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="hpu", **kwargs):
