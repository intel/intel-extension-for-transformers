...
tokenizer = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-zh-en") ### zh -> en
model = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-zh-en").to(device)

now = time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime())
output_dir = f'./checkpoint-opus-mt-zh-sh-{now}'
