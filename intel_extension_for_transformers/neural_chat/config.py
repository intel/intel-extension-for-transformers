...
class TTSDatasetArguments:
    audio_folder_path: Optional[str] = field(
        default=None, metadata={"help": "The path to the directory of audios."}
    )
    text_folder_path: Optional[str] = field(
        default=None, metadata={"help": "The path to the directory of texts."}
    )
...
class PipelineConfig:
    def __init__(
        ...
        self.optimization_config = (
            ...
            else MixedPrecisionConfig(
                dtype="float16" if self.device == "cuda" else "bfloat16"
            )
        )
