...
* Leverage the leading AI frameworks (e.g., [PyTorch](https://pytorch.org/) and extend the popular domain libraries (e.g., [Hugging Face](https://github.com/huggingface), [Langchain](https://www.langchain.com/))
...
<p align="center">
  <img src="./docs/images/neuralchat_arch.png" alt="NeuralChat" width=600 height=400>
</p>
</a>
