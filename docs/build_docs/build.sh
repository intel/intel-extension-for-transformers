...
if [[ ${UPDATE_VERSION_FOLDER} -eq 1 ]]; then
  ...
  cp -r ./source/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/docs/imgs ${DST_FOLDER}/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/docs
  cp -r ./source/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/kernels/docs/imgs ${DST_FOLDER}/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/kernels/docs
...
if [[ ${UPDATE_LATEST_FOLDER} -eq 1 ]]; then
  ...
  cp -r ./source/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/docs/imgs ${LATEST_FOLDER}/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/docs
  cp -r ./source/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/kernels/docs/imgs ${LATEST_FOLDER}/docs/intel_extension_for_transformers/transformers/llm/runtime/deprecated/kernels/docs
