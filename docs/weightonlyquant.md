...
woq_config = WeightOnlyQuantConfig( 
                                    weight_dtype="int4", #int8/int4
                                    compute_dtype="int8" #int8/fp32
                                    )
...
```bash
from intel_extension_for_transformers.transformers import AutoModelForCausalLM, WeightOnlyQuantConfig
woq = WeightOnlyQuantConfig(
                            weight_dtype="int4_fullrange",  #int8/int4_fullrange/int4_clip/nf4/fp4_e2m1_bnb/fp4_e2m1
                            group_size=32
                            )
