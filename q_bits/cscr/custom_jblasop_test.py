...
bias*=10
trans_quant_wei=torch.ops.weight_only_jblasop.jblas_quantize(trans_raw_wei,True,"sym",32,"int8","s4_fullrange");
# print(trans_raw_wei)
...
print("==========bias========")
print(bias)
torch.ops.weight_only_jblasop.jblas_quantweight_f32_linear_with_bias(activation,trans_quant_wei,bias,trans_dst,2,3,32,32,3,"int8","s4_fullrange")
print("==============transformat with bias result===============")
print(trans_dst)
print("~~~~~~~~~~~~~~~~~~")
print(trans_correct+bias)
torch.ops.weight_only_jblasop.jblas_quantweight_f32_linear_without_bias(activation,trans_quant_wei,trans_dst,2,3,32,32,3,"int8","s4_fullrange")
