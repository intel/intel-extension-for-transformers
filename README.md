...
* Blog published on datalearner: [Analysis of the top ten popular open source LLM by HuggingFace in the fourth week of November 2023 - the explosion of multi-modal large models and small-scale models](https://www.datalearner.com/blog/1051701014024122) (Nov 2023)
* Blog published on zaker: [LLMs inference performance is accelerated up to 40 times using this toolkit](https://app.myzaker.com/news/article.php?pk=656857148e9f0961d70ac3d3) (Nov 2023)
