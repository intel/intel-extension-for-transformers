<script lang="ts">
	import person_outlined from "$lib/assets/portrait.svg";

	export let role: string;
</script>

{#if role === "Assistant"}
	<figure class="bg-button w-10 h-10 p-1">
		<svg version="1.1" class="w-full h-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
{:else}
	<img src={person_outlined} alt="" class="w-10 h-10" />
{/if}