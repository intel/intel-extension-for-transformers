...
#ifndef ENGINE_SPARSELIB_INCLUDE_KERNELS_SOFTMAX_REF_HPP_
#define ENGINE_SPARSELIB_INCLUDE_KERNELS_SOFTMAX_REF_HPP_
...
class softmax_ref_kd_t : public kernel_desc_t {
 public:
  explicit softmax_ref_kd_t(const jd::operator_desc& op_desc)
