...
#ifndef ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_MATMU_VNNI_BA4B_AB4A_BA_HPP_
#define ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_MATMU_VNNI_BA4B_AB4A_BA_HPP_
...
namespace jd {
/**
 * @brief jit_matmul_vnni_Ba4b_Ab4a_ba_t calculates this kind matmul: scale * src0 x src1 = dst.
 *        scale * src0(M, K) x src1(K, N) = dst^T(N, M) where M=TH_x16 N=TW_x1
 */
...
#endif  // ENGINE_SPARSELIB_INCLUDE_JIT_DOMAIN_JIT_MATMU_VNNI_BA4B_AB4A_BA_HPP_
