...
template <typename tile_op_t_, typename quant_op_t_, typename tile_shape_,
        typename mem_desc_c_t_, gpu_arch arch_tag_>
class epilogue_t<epilogue_policy_quant_op<tile_op_t_, quant_op_t_, arch_tag_>,
        tile_shape_, mem_desc_c_t_,
        std::enable_if_t<(arch_tag_ == gpu_arch::Xe)>> {
public:
    using epilogue_policy
            = epilogue_policy_quant_op<tile_op_t_, quant_op_t_, arch_tag_>;
    ...
    struct arguments_t {
        ...
        inline arguments_t(typename tile_op_t::arguments_t tile_op_args_,
            ...
            : tile_op_args(tile_op_args_), quant_op_args(quant_op_args_) {}
...
public:
    ...
    __XETLA_API KERNEL_FUNC void operator()(work_group_t &g, matAcc_t &matAcc,
        ...
        quant_op(matC, matAcc, mem_desc_c.coord, args.quant_op_args);
