...
def main():
    ...
    if training_args.nncf_config is not None:
        ...
        if training_args.do_train:
            train_dataloader = get_nncf_train_dataloader_for_init(
                training_args,
                train_dataset,
    ...
    if optim_args.tune:
        ...
        trainer.provider = "nncf"
        trainer.provider_arguments = {
            "nncf_config": nncf_config,
            "to_onnx": training_args.to_onnx,
            "distributed": True if not (training_args.local_rank == -1 or training_args.no_cuda) else False,
        }
