...
def main():
    ...
    if optim_args.distill:
        ...
        from intel_extension_for_transformers.optimization import metrics, DistillationConfig, TFOptimization
        ...
        assert optim_args.layer_mappings is not None, "layer_mappinps should not be None"
        criterion = Criterion(name=optim_args.distillation_mode,
                                temperature=optim_args.temperature,
                                loss_types=loss_type,
                                loss_weight_ratio=loss_weight_ratio,
                                layer_mappings=[optim_args.layer_mappings]
                                if optim_args.layer_mappings else None,
        ...
        distilled_model = optimization.distill(
