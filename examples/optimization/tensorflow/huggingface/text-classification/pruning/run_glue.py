...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TFTrainingArguments, OptimizationArguments))
    ...
    with training_args.strategy.scope():
        ...
        # endregion
        if optim_args.prune:
            from nlp_toolkit import metrics, PrunerConfig, PruningConfig, TFOptimization
            ...
            p_model.save_pretrained(training_args.output_dir, saved_model=True)
            p_model.config.save_pretrained(training_args.output_dir)
