...
def get_example_inputs(tokenized_dataset, model_config, model_type="llama"):
...
if args.accuracy:
    ...
    import sys
    sys.path.append('/home/kaihui/code/bug_fix/pt/neural-compressor')
