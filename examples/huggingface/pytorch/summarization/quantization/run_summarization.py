...
require_version("datasets>=1.17.0", "To fix: pip install -r examples/pytorch/summarization/requirements.txt")
...
def main():
    ...
    parser = HfArgumentParser(
        (ModelArguments, DataTrainingArguments, Seq2SeqTrainingArguments, OptimizationArguments)
    )
    ...
    if optim_args.benchmark_only:
        ...
        arch_list = [arch for model, arch in \
            transformers.AutoModelForSeq2SeqLM._model_mapping._model_mapping.items()]
