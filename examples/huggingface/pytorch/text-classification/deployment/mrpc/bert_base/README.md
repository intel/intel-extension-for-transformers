...
```shell
bash run_bert_base.sh --model=textattack/bert-base-uncased-MRPC  --dataset=mrpc --precision=fp32
```

By setting `precision=int8` you could get PTQ int8 model and setting `precision=bf16` to get bf16 model.
```shell
bash run_emotion.sh --model=textattack/bert-base-uncased-MRPC  --dataset=mrpc --precision==int8
```
