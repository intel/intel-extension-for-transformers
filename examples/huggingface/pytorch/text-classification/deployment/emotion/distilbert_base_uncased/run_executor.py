...
def get_args():
    ...
    parser.add_argument("--input_model", default="./ir", type=str, help="Input model path.")
    ...
    parser.add_argument("--dataset_name", default="emotion", type=str, help="Name of dataset.")
