Step-by-Step
============
This example used [Neural Engine](https://github.com/intel/intel-extension-for-transformers/tree/main/intel_extension_for_transformers/transformers/runtime) to get the MLPerf performance. It can test model `Bert Large Squad Sparse` and `MiniLM L12`.
