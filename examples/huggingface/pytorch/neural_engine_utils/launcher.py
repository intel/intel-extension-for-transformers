...
def get_memory_settings(path, args):
    ...
    memory_prefix_list = []
    jemalloc_prefix = "LD_PRELOAD={}/intel_extension_for_transformers/transformers/runtime/"\
...
def set_jemalloc_env(env_cmd, memory_allocator, path):
    ...
    if memory_allocator == "jemalloc":
        env_cmd["LD_PRELOAD"] = "{}/intel_extension_for_transformers/transformers/runtime/executor/" \
