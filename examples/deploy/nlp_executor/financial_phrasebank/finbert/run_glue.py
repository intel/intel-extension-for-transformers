...
task_to_keys = {
    ...
    "sentences_50agree": ("sentence",None),
}
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        raw_datasets = load_dataset("financial_phrasebank", data_args.dataset_config_name, cache_dir=model_args.cache_dir)
    ...
    if data_args.task_name is not None:
        metric = load_metric("financial_phrasebank", data_args.task_name)
    else:
