...
class Executor(object):
    ...
    def accuracy(self, batch_size, seq_len, 
        ...
        pearson_value = eval_metric.get("pearson")
        spearmanr_value = eval_metric.get("spearmanr")
        accuracy_value = (pearson_value+spearmanr_value)/2
        log.info(f"Pearson: {pearson_value}")
        log.info(f"Spearmanr: {spearmanr_value}")
