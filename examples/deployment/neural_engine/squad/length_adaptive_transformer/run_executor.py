...
def get_args():
    ...
    parser.add_argument("--seq_len", default=384, type=int, help="Sequence length.")
    parser.add_argument("--max_eval_samples",
                        default=-1,
                        type=int,
                        help="Sample number for evaluation.")
    ...
    parser.add_argument("--tokenizer_dir",
                        default="sguskin/dynamic-minilmv2-L6-H384-squad1.1",
                        type=str,
    ...
    parser.add_argument("--dataset_name", default="squad", type=str, help="Name of dataset.")
