...
def get_args():
    ...
    parser.add_argument("--input_model", default="./ir",
    ...
    parser.add_argument("--tokenizer_dir", default="bhadresh-savani/distilbert-base-uncased-emotion", type=str,
                        help="Pre-trained model tokenizer name or path")
    parser.add_argument("--data_dir", default="./data", type=str,
                        help="Data cache directory.")
    parser.add_argument("--dataset_name", default="emotion", type=str,
...
if __name__ == '__main__':
    ...
    if args.mode == "accuracy":
        executor.accuracy(args.batch_size, args.seq_len, args.dataset_name,
                          args.task_name, args.data_dir, args.tokenizer_dir)
