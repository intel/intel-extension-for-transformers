...
LOG_DIR=/log_dir
mkdir -p ${LOG_DIR}
WORKING_DIR="/intel-extension-for-transformers/intel_extension_for_transformers/transformers/llm/runtime/deprecated"
...
function pytest() {
    ...
    engine_path="${engine_path}/transformers/llm/runtime"
