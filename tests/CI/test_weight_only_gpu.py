...
from intel_extension_for_transformers.utils.utils import _ipex_available, get_gpu_family
...
class DummyDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if index < 10:
            ...
            res = torch.tensor(input_ids), torch.tensor(
                self.encoded_dict["attention_mask"]
            )
            return res
...
@unittest.skipIf(
    not _ipex_available or gpu_name == "no_gpu",
