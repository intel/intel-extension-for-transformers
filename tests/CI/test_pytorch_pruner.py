...
from intel_extension_for_transformers.transformers.pruner import (
    Pruning,
    WeightPruningConfig,
)
...
class TestPruning(unittest.TestCase):
    ...
    def test_pruning_basic(self):
        ...
        config = WeightPruningConfig(
            local_configs, target_sparsity=0.8, start_step=1, end_step=10
        )
        ...
        x_train = np.random.uniform(low=0.0, high=1.0, size=tuple([10, 3, 224, 224]))
