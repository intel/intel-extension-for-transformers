...
class TestOrchestrateOptimizations(unittest.TestCase):
    ...
    def test_fx_orchestrate_optimization(self):
        ...
        pruner_config = PrunerConfig(
            prune_type="PatternLock", target_sparsity_ratio=0.9
        )
        pruning_conf = PruningConfig(
            framework="pytorch_fx", pruner_config=[pruner_config], metrics=tune_metric
        )
        ...
        opt_model = self.trainer.orchestrate_optimizations(
