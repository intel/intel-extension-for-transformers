...
class TestDistillation(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        def preprocess_function(examples):
            ...
            result = self.tokenizer(*args, padding=True, max_length=64, truncation=True)
            return result
    ...
    def test_tf_model_distil(self):
        ...
        self.assertEqual(
            distilled_model.signatures["serving_default"].output_shapes["Identity"],
            distilled_model2.signatures["serving_default"].output_shapes["Identity"],
        )
